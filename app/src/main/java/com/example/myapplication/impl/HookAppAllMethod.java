...
public class HookAppAllMethod {
    ...
    private static final String FILTER_PKGNAME = "me.weishu.exp";
    ...
    public static boolean dumpAllMethodInfo() {
        L.i("all method size:" + methodSignSet.size());
        ...
        try {
            ...
            L.i("dump all method error:" + Log.getStackTraceString(e));
            return false;
        } finally {
            try {
                if (fw != null) {
    ...
    public static boolean dumpCallMethodInfo() {
        L.i("call method size:" + callMethodSignSet.size());
        ...
        try {
            ...
            L.i("dump call method error:" + Log.getStackTraceString(e));
            return false;
        } finally {
            try {
                if (fw != null) {
